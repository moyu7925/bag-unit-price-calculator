...
一个基于Kivy框架开发的Android应用，用于计算袋子的单价，支持多种材质计算和模板管理。
...
- 上半区（40%）：信息展示区，以列表形式显示所有计算结果
- 下半区（60%）：数据输入区，包含所有参数输入和模块控制
...
本项目配置了GitHub Actions自动构建APK，每次推送到main分支时自动触发构建。
...
**提示**：详细使用说明请查看 [README.md](mobile/README.md) 文件。
